...
class Agent:
    ...
    def __init__(self, env, policy, device, eval_env=None,custom_reward=None, running_state=None, num_threads=1):
        self.env = env
        self.policy = policy
        self.device = device
    ...
    def collect_samples(self, min_batch_size, eval_flag=False,mean_action=False, render=False):
        t_start = time.time()
        ...
        memory, log = collect_samples(0, None, collect_sample_env, self.policy, self.custom_reward, mean_action,
